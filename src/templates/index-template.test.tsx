...
describe("IndexTemplate", () => {
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "twitter:title")).toEqual("Posts - Page 2 - Blog by Mafalda Timóteo");
    expect(getMeta(container, "og:title")).toEqual("Posts - Page 2 - Blog by Mafalda Timóteo");
