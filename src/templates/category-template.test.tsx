...
describe("CategoryTemplate", () => {
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "og:title")).toEqual("Typography - Page 2 - Blog by Mafalda Timóteo");
    expect(getMeta(container, "twitter:title")).toEqual("Typography - Page 2 - Blog by Mafalda Timóteo");
